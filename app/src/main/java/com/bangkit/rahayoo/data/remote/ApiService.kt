...
interface ApiService {
    ...
    suspend fun register(@Header("Authorization") authorization: String, @Body body: RegisterBody): Response<MessageResponse>

    @POST("api/auth/user-update")
    suspend fun updateUser(@Header("Authorization") authorization: String, @Body body: UserBody): Response<MessageResponse>
